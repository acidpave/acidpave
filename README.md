...
[![JS, TS, WebAssembly, CoffeeScript, HTMX, Svelte, Tailwind CSS, Lua, Ruby, Swift, Rust, Zig, Kotlin, Fortran, MYSql, SQLite, PHP, .NET, LaTeX, Unity, Godot, Roblox Studio, Figma, Powershell, Wordpress](https://skillicons.dev/icons?i=js,ts,wasm,coffeescript,htmx,svelte,tailwind,lua,ruby,go,powershell,swift,rust,zig,kotlin,fortran,mysql,sqlite,php,dotnet,latex,unity,godot,robloxstudio,figma,wordpress&theme=light)](https://skillicons.dev)
